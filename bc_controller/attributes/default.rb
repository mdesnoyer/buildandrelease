...
default[:bc_controller][:microsoft_ingester_config] = "#{node[:neon][:config_dir]}/microsoft_ingester.conf"
...
default[:bc_controller][:microsoft_ingester_log_file] = "#{node[:bc_controller][:log_dir]}/microsoft_ingester.log"
...
default[:bc_controller][:microsoft_service_name] = "microsoft"
