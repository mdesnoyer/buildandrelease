...
default[:video_client][:model_files] = [default[:video_client][:model_file], default[:video_client][:model_data_folder] + "/svm_pca/*", default[:video_client][:model_data_folder] + "/pca/*"]
